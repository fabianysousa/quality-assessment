...
public class IncluirMercadoriaFrame extends JFrame {
	...
	public void configFrame(String title, boolean visible, boolean reset, Mercadoria merc) {
		if(title != null) {
			setTitle(title);
		}
		if(!visible) {
